...
-- Роли
-- ----------------------------
-- Увеличение игровых значений пользователям
local increaseUserStats = require('src.roles.increaseUserStats')
increaseUserStats.init()
...
commandLoader {
  -- Maintenance
  'src.commands.maintenance.maint',
  -- Private
